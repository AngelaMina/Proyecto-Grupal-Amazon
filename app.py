...
imagen_logo = Image.open("imagen/Logo.PNG")
...
imagen_azure = Image.open("imagen/entorno.PNG")
imagen_power = Image.open("imagen/power_bi.PNG")
imagen_streamlit = Image.open("imagen/streamlit.PNG")
imagen_angela = Image.open("imagen/Angela.PNG")
imagen_cristhian = Image.open("imagen/Cristhian.PNG")
imagen_esteban = Image.open("imagen/Esteban.PNG")
imagen_gaston =Image.open("imagen/Gaston.PNG")
